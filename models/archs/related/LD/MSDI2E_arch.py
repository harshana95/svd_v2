...
# from models.archs.related.LD.architecture16 import SPADEResnetBlock1 as SPADEResnetBlock
from models.archs.related.LD.encoder2 import ConvEncoder
from models.archs.related.LD.generator import HINet
...
class MSDI2E_config(PretrainedConfig):
    model_type = "MSDI2E_arch"
...
class MSDI2E_arch(PreTrainedModel):
    config_class = MSDI2E_config
