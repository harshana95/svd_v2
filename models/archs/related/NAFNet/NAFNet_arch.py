...
from models.archs.related.NAFNet.arch_util import LayerNorm2d
...
class NAFNet_config(PretrainedConfig):
...
class NAFNet_arch(PreTrainedModel):
    config_class = NAFNet_config
