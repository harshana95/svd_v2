...
from models.archs.related.NAFNet.NAFNet_arch import LayerNorm2d, NAFBlock
from models.archs.related.NAFNet.arch_util import MySequential
from models.archs.related.NAFNet.local_arch import Local_Base
...
class SCAM(nn.Module):
    ...
    def __init__(self, c):
        ...
        self.theta = nn.Parameter(torch.zeros((1, c, 1, 1)), requires_grad=True)
        self.psi = nn.Parameter(torch.zeros((1, c, 1, 1)), requires_grad=True)
    ...
    def forward(self, x_l, x_r):
        ...
        # scale
        F_r2l = F_r2l.permute(0, 3, 1, 2) * self.theta
        F_l2r = F_l2r.permute(0, 3, 1, 2) * self.psi
