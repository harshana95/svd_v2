...
from models.OneStepDiffusion.OSEDiff_SD3_onedataset_model import OSEDiff_SD3_onedataset_model, encode_prompt_sd3
...
class OSEDiff_SD3_twodataset_model(OSEDiff_SD3_onedataset_model, TwoDatasetBasemodel):
    def __init__(self, opt, logger):
        super(OSEDiff_SD3_twodataset_model, self).__init__(opt, logger)
