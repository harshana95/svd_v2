    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                k_2 = self.lkpn(latent_model_input, z_2, torch.tensor([t]*batch_size, device=device))
        ...
        return PipelineOutput(images=step_outputs[-1], step_outputs=step_outputs, timesteps=timesteps)
